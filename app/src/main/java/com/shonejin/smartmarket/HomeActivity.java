...
public class HomeActivity extends AppCompatActivity {
    ...
    public static String catogory = "All";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new com.shonejin.smartmarket.Adpater.PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    private void addDrawerItems() {
        final String[] categoryArray = { "All", "Books", "Electronics", "Gourment Food",
                "Apparel"};
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                catogory = categoryArray[position];
                Toast.makeText(HomeActivity.this, "Selected " + catogory, Toast.LENGTH_SHORT).show();
            }
        });
    }
